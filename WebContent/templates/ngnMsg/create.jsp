...
<table width="580" border="0"  align="center" cellpadding="0" cellspacing="0" class="msc-table">
    <tr><th align="right" width="100">发送者ID:</th>
      <td align="left">
         <input type="text" id="userid" name="userid" size="24" class="input_001" value=""/>
         <span id="useridTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">接收者ID:</th>
      <td align="left">
         <input type="text" id="touserid" name="touserid" size="24" class="input_001" value=""/>
         <span id="touseridTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">消息内容:</th>
      <td align="left">
         <input type="text" id="msg" name="msg" size="24" class="input_001" value=""/>
         <span id="msgTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">发送日期:</th>
      <td align="left">
         <input type="text" id="senddate" name="senddate" size="24" class="input_001" value=""/>
    ...
    <tr>
			...
			<img src="/images/button_cz.gif" style="cursor: pointer;"	onclick="javascript:document.forms['createNgnMsg'].reset();"> 
			</td>
		</tr>
</table>
</form>
