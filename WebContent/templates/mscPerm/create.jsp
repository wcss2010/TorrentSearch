...
<%PAGE_TITLE="新增MscPerm"; %>
<%@include file="/include/header.jsp"%>
<script type="text/javascript">
$(document).ready(function(){
	$.formValidator.initConfig({
		formID : "createMscPerm",
		debug:false,
		submitOnce:true,
...
<form id="createMscPerm" name="createMscPerm" method="post" action="doCreate.jsp">
<table width="580" border="0"  align="center" cellpadding="0" cellspacing="0" class="msc-table">
    <tr><th align="right" width="100">菜单所属的上级ID:</th>
      <td align="left">
         <input type="text" id="parentId" name="parentId" size="24" class="input_001" value=""/>
         <span id="parentIdTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">0.是菜单项，1是api:</th>
      <td align="left">
         <input type="text" id="permType" name="permType" size="24" class="input_001" value=""/>
         <span id="permTypeTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">权限的名称:</th>
      <td align="left">
         <input type="text" id="permName" name="permName" size="24" class="input_001" value=""/>
         <span id="permNameTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">权限的描述:</th>
      <td align="left">
         <input type="text" id="permDesc" name="permDesc" size="24" class="input_001" value=""/>
         <span id="permDescTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">拥有子元素的个数:</th>
      <td align="left">
         <input type="text" id="childNum" name="childNum" size="24" class="input_001" value=""/>
         <span id="childNumTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">权限执行的url目录:</th>
      <td align="left">
         <input type="text" id="actionUrl" name="actionUrl" size="24" class="input_001" value=""/>
         <span id="actionUrlTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">单位目录层次深度:</th>
      <td align="left">
         <input type="text" id="menuLayer" name="menuLayer" size="24" class="input_001" value=""/>
         <span id="menuLayerTip"></span>
      </td>
     </tr>
    <tr><th align="right" width="100">单位层次路径:</th>
      <td align="left">
         <input type="text" id="menuPath" name="menuPath" size="24" class="input_001" value=""/>
    ...
    <tr><th align="right" width="100">最后一次的修改时间:</th>
      <td align="left">
    ...
    <tr>
			...
			<img src="/images/button_cz.gif" style="cursor: pointer;"	onclick="javascript:document.forms['createMscPerm'].reset();"> 
			</td>
		</tr>
</table>
</form>
