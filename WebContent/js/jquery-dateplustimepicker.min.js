	...
	*/
    ...
    $.extend(Dateplustimepicker.prototype, {
		...
		_generateHtml: function(inst) {
            ...
            html += '<span class="ui-dateplustimepicker-time-label ui-dateplustimepicker-label">' + timeText + '</span>&nbsp;&nbsp;&nbsp;';
            html += '<span class="ui-dateplustimepicker-time-value ui-dateplustimepicker-value">' + time + '</span>';
			html += '</div>';
		...
		_setTimeFromDateTimeString: function(inst, datetimeString, noDefault) {
			...
			//var timeString = tokens.splice(1).join(' '); //ie和ff不兼容
			var timeString = tokens[1];
