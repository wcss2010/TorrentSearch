...
int RESULT_NUM=30;
//session登录
MscUser MSC_USER=(MscUser)session.getAttribute("userInfo");
if(MSC_USER==null || MscSingleLogonService.getLogonMap().get(MSC_USER.getId())==null){
	response.sendRedirect("/alertPage.jsp");
}
